namespace Neovolve.Toolkit.LoadTests.Threading
{
    ...
    /// <summary>
    /// The <see cref="ReaderWriterLockTests"/>
    ///   class contains unit tests for <see cref="ReaderWriterLock"/> implementations.
    /// </summary>
    [TestClass]
    public class ReaderWriterLockTests
    {
        /// <summary>
        ///   Stores the lock reference.
        /// </summary>
        private static readonly ReaderWriterLock _lock = new ReaderWriterLock();

        /// <summary>
        ///   Stores the data store reference.
        /// </summary>
        private static readonly Dictionary<Int32, Int32> _store = new Dictionary<Int32, Int32>();

        /// <summary>
        /// Runs test for run reader writer lock read.
        /// </summary>
        [TestMethod]
        public void RunReaderWriterLockReadTest()
        {
        ...
        /// <summary>
        /// Runs test for run reader writer lock write only.
        /// </summary>
        [TestMethod]
        public void RunReaderWriterLockWriteOnlyTest()
        {
        ...
        /// <summary>
        /// Runs test for run reader writer lock write.
        /// </summary>
        [TestMethod]
        public void RunReaderWriterLockWriteTest()
        {
            using (new LockReader(_lock))
            {
                Int32 newValue = _store.Count;
